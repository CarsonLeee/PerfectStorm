...
public class main {
    ...
    public static void addComponentsToPane(Container pane) throws Exception {
        ...
        ImageIcon timerjpg = new ImageIcon(new ImageIcon("timer.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon playjpg = new ImageIcon(new ImageIcon("play.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon resetjpg = new ImageIcon(new ImageIcon("reset.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));

        ImageIcon rainjpg = new ImageIcon(new ImageIcon("rain.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon windjpg = new ImageIcon(new ImageIcon("wind.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon birdsjpg = new ImageIcon(new ImageIcon("birds.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon thunderjpg = new ImageIcon(new ImageIcon("thunder.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon cicadajpg = new ImageIcon(new ImageIcon("cicada.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon staticjpg = new ImageIcon(new ImageIcon("static.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
        ImageIcon fireplacejpg = new ImageIcon(new ImageIcon("fireplace.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));       
        ImageIcon frogsjpg = new ImageIcon(new ImageIcon("frog.jpg").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT));
	...
	play.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if (action.equals("pressed")) {
				...
				rainwav.setFile("rain.wav");
				windwav.setFile("wind.wav");
				frogswav.setFile("frogs.wav");
				fireplacewav.setFile("fireplace.wav");
				staticwav.setFile("static.wav");
				birdswav.setFile("birds.wav");
				thunderwav.setFile("thunder.wav");
				cicadaswav.setFile("cicada.wav");
